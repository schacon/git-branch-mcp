...
class CommitMessageFormatter {
   ...
   */
  static wrapLine(line, leading = null, indent = null) {
   ...
   */
  static formatForCommit(message) {
   ...
   */
  static parseForUi(formattedMessage) {
    // Split the message into paragraphs
